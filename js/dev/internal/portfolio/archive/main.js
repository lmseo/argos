 ...
 * Build: http://modernizr.com/download/#-backgroundsize-borderradius-opacity-rgba-textshadow-cssanimations-csstransforms-csstransforms3d-csstransitions-svg-touch-shiv-mq-cssclasses-prefixed-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
	...
	function init() {
		...
		[].forEach.call( document.querySelectorAll( '.zp-grid-wrapper' ), function( el ) {
			...
			var grid = el.querySelector( '.zp-grid' ),
			    ...
			    var grid = el.querySelector( '.portfolio_archive_element_wrapper' ),
				items = [].slice.call( grid.querySelectorAll( 'div' ) ),
				navDots = [].slice.call( el.querySelectorAll( '.zp_portfolio_nav > a' ) ),
				isAnimating = false,
							current = 0;
...
(function(window, document, undefined){
    ...
    window.App = (function(){
        ...
        window.onload = function() {
            inner = document.getElementById('sidebar_container'),
